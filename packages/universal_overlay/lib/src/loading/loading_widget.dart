...
class LoadingOverlayWidget extends StatelessWidget {
  ...
  /// Loading callbacks
  final LoadingCallbacks callbacks;

  /// Loading theme (behavior + styling)
  ...
  Widget build(BuildContext context) {
    ...
    final barrierColor = resolvedTheme.barrierColor;

    final animationBuilder =
        resolvedTheme.animationBuilder ?? OverlayAnimations.scale();
    ...
    Widget barrier = GestureDetector(
      onTap: resolvedTheme.barrierDismissible
    ...
    if (!resolvedTheme.allowBackButton) {
      barrier = PopScope(
        canPop: false,
        onPopInvokedWithResult: (didPop, _) {
          if (!didPop && resolvedTheme.barrierDismissible) {
