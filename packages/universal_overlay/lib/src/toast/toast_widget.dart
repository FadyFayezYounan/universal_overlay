...
class _ToastWidgetState extends State<ToastWidget> {
  ...
  void _startTimer() {
    if (widget.theme.dismissalTypes.contains(DismissalType.timer)) {
      Future.delayed(widget.theme.duration, () {
  ...
  DismissDirection _getSwipeDirection() {
    if (widget.theme.swipeDismissDirection != null) {
      return widget.theme.swipeDismissDirection!;
    }

    // Auto-determine based on position
    switch (widget.theme.position) {
  ...
  Widget _buildToastContent(BuildContext context) {
                    ...
                    if (widget.content.action != null) ...[
                      ...
                      TextButton(
                        onPressed: () {
                          ...
                          widget.callbacks.onActionPressed?.call();
    ...
    if (widget.theme.dismissalTypes.contains(DismissalType.swipe)) {
  ...
  Widget build(BuildContext context) {
    ...
    final enterBuilder = widget.theme.enterAnimationBuilder ??
